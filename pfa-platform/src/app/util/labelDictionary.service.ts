...
export class LabelDictionaryService { 
    ...
    getDictionary() {
        ...
        dict['homePageTitle'] = {en: 'A New Platform', it: 'Una nuova piattaforma'};
        dict['homePageSubtitle'] = {en: 'for your future well being', it: 'per un futuro tranquillo'};
        ...
        dict['planningTitle'] = {en: 'Your plan', it: 'Il tuo piano'};
        dict['planningSubtitle'] = {en: 'Plan your objectives and see what will happen', it: 'definisci i tuoi obiettivi e controllali nel tempo'};
        ...
        dict['report'] = {en: 'Report', it: 'Report'};
        dict['reportTitle'] = {en: 'Your Report', it: 'Il tuo report'};
        dict['reportSubtitle'] = {en: 'print your report', it: 'stampa il tuo report'};
